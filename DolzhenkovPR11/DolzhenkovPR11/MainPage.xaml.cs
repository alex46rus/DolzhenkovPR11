...
namespace DolzhenkovPR11
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            var rnd = new Random();
            var data = new[] { "Группа: ПКС-31", "ФИО: Долженков Алексей Дмитриевич", "Программист со стажем", "Безработный", "В активном поиске", $"Сегодня:{DateTime.Now}" };
